...
probe_top = visual.Circle(win=win, radius=probe_size_px, fillColor='red', contrast=.8)
probe_bot = visual.Circle(win=win, radius=probe_size_px, fillColor='red', contrast=.8)
